...
def _deal_card(frame):
    ...
    # and add it to back fo the pack
...
def score_hand(hand):
    ...
    # only one ace can have the value 11, and this will be reduce to 1 if
    # the hand would bust
    score = 0
    ace = False
...
def new_game():
    ...
    # create the list to store the dealer's amd player's hands
    dealer_hand = []
    player_hand = []
    initial_deal()
...
# Set up the screen and frames from the dealer and player
