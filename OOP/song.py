...
class Album:
    ...
    Attributes:
        ...
        Methods:
            add_song: Used to add a new dong to the albums's track list.
        """
    ...
    def add_song(self, artist, song, position=None):
        """Adds a song to the track list

        Args:
            song (str): The title of a song to add.
            position (Optional[int]): If specified, the song will be added to that
                position in the track list - inserting it between other songs if
                necessary. Otherwise, the song will be added to the end of the list.
        """
        song_found = find_object(song, self.tracks)
        if song_found is None:
            song_found = Song(song, title, self.artist)
            if position is None:
...
class Artist:
    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album object to add to the list.
                ...
                again (although this is yet to be implemented).
        """
    ...
    def add_song(self, name, year, title):
        ...
        A new album will be created in the collection if it
        ...
        album_found.add_song(title, name)
